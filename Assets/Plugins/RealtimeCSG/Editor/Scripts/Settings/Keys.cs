...
namespace RealtimeCSG
{
	internal static class Keys
	{
		...
		public static readonly KeyEvent SphereBuilderMode				= new KeyEvent(KeyCode.M, hold: true);
...
//		public static readonly KeyEvent VerticalMoveMode				= new KeyEvent(KeyCode.Z, hold: true);
		...
		public static readonly KeyEvent MoveSelectionLeft				= new KeyEvent(KeyCode.LeftArrow, EventModifiers.Control);
		[KeyDescription("Selection/Move right")]
		public static readonly KeyEvent MoveSelectionRight				= new KeyEvent(KeyCode.RightArrow, EventModifiers.Control);
		[KeyDescription("Selection/Move right")]
		public static readonly KeyEvent MoveSelectionBack				= new KeyEvent(KeyCode.DownArrow, EventModifiers.Control);
		[KeyDescription("Selection/Move forward")]
		public static readonly KeyEvent MoveSelectionForward			= new KeyEvent(KeyCode.UpArrow, EventModifiers.Control);
		[KeyDescription("Selection/Move down")]
		public static readonly KeyEvent MoveSelectionDown               = new KeyEvent(KeyCode.PageDown, EventModifiers.Control);
		[KeyDescription("Selection/Move up")]
		public static readonly KeyEvent MoveSelectionUp					= new KeyEvent(KeyCode.PageUp, EventModifiers.Control);
