...
namespace RealtimeCSG
{
	...
	internal struct AABB
	{
		...
		{
			Add(new Vector3(other.MinX, other.MinY, other.MinZ));
			Add(new Vector3(other.MaxX, other.MaxY, other.MaxZ));
		}
		public void Add(AABB other, Vector3 offset)
		{
			Add(new Vector3(other.MinX + offset.x, other.MinY + offset.y, other.MinZ + offset.z));
			Add(new Vector3(other.MaxX + offset.x, other.MaxY + offset.y, other.MaxZ + offset.z));
		}
