...
namespace RealtimeCSG
{
    ...
    internal sealed class BoxSettings : IShapeSettings
	{
		...
		public Vector3[] GetVertices(CSGPlane buildPlane, Vector3 worldPosition, Vector3 gridTangent, Vector3 gridBinormal, out bool isValid)
		{
			...
			return new Vector3[] {
				corner0,
				corner0 + projected_length,
				corner0 + projected_width + projected_length,
				corner0 + projected_width				
			};
		}
		...
		public RealtimeCSG.AABB CalculateBounds(Vector3 gridTangent, Vector3 gridBinormal)
		{
			...
			var point0 = center;
			var point1 = center + projected_width;
			var point2 = center + projected_length;
			var point3 = corner;
